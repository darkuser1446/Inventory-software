...
async function main() {
    ...
    const orders = await Promise.all([
        prisma.order.create({
            data: {
                ...
                source: client_1.OrderSource.AMAZON,
        ...
        prisma.order.create({
            data: {
                ...
                source: client_1.OrderSource.FLIPKART,
        ...
        prisma.order.create({
            data: {
                ...
                source: client_1.OrderSource.MEESHO,
                status: client_1.OrderStatus.PENDING,
        ...
        prisma.order.create({
            data: {
                ...
                source: client_1.OrderSource.WEBSITE,
    ...
    await Promise.all([
        prisma.integration.upsert({
            where: { platform_companyId: { platform: client_1.OrderSource.AMAZON, companyId: company.id } },
            update: {},
            create: {
                platform: client_1.OrderSource.AMAZON,
                name: 'Amazon India',
        ...
        prisma.integration.upsert({
            where: { platform_companyId: { platform: client_1.OrderSource.FLIPKART, companyId: company.id } },
            update: {},
            create: {
                platform: client_1.OrderSource.FLIPKART,
